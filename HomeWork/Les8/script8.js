...
class Princ extends Human {
    ...
    find1(arr) {
        for (const item of arr) {
            if (princ.findSize === item.legSize) {
                // return item;
                console.log(item);
            }
        }
    ...
    find2(arr) {
         return arr.find((item) => item.legSize === this.findSize);
     }
...
(princ.find1(princesaArr))
console.log(princ.find2(princesaArr))
